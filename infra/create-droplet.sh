...
NC_DESK_ENV=$ENVF NC_DOMAIN=$NC_DOMAIN NC_KEYBOARD=$NC_KEYBOARD NC_DESK_USER=${NC_DESK_USER:-user} NC_SIZE=$SIZE NC_PRICE_HOURLY=$PRICE sh "$DIR/provision-host.sh" "$IP" "$NAME"
